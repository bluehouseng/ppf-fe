        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
            ...
            <div className="md:w-[740px]">
              ...
              The Prince Ponfa Miri {' '}
                <span className="relative inline-flex text-blue-400">
                  <svg
              ...
              A non-profit youth-centered civic innovation lab and policy research think-tank collaborating for effective implementation of the UN's 2030 Agenda for Sustainable Development and Africa's 2030 goals.
              </p>
              {/* Buttons */}
              <div
