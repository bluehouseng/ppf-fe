                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">Thanks to code Plateau and thanks to Plateau State government for the opportunity giving to us to be equipped in tech skills</h4>
                      <div>
