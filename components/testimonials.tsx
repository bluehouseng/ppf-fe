...
import TestimonialsImage01 from '@/public/images/inspi 1.jpg'
import TestimonialsImage02 from '@/public/images/inspi 2.jpg'
import TestimonialsImage03 from '@/public/images/inspi 3.jpg'
                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    <div className="shrink-0 relative inline-flex">
                      ...
                      <div className="absolute right-0 bottom-0 mr-4 mb-6">
                        <a className="flex items-center font-cabinet-grotesk font-bold decoration-blue-500 decoration-2 underline-offset-2 hover:underline px-3 py-1 bg-white rounded-full shadow-sm" href="https://www.facebook.com/thankgod.joshua2?mibextid=ZbWKwL">
                        <FontAwesomeIcon icon={faFacebook} className='w-8 h-8' />
                          <span>ThankGod Joshua</span>
                        </a>
                      </div>
                    </div>
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">Wow. I'm really humbled Sir. You've been a great impact on the youths. Pray for more grace to fulfill your dreams and aspirations!.</h4>
                      <div>
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    <div className="shrink-0 relative inline-flex">
                      ...
                      <div className="absolute right-0 bottom-0 mr-4 mb-6">
                        <a className="flex items-center font-cabinet-grotesk font-bold decoration-blue-500 decoration-2 underline-offset-2 hover:underline px-3 py-1 bg-white rounded-full shadow-sm" href="https://www.facebook.com/profile.php?id=100005736368063&mibextid=ZbWKwL">
                        <FontAwesomeIcon icon={faFacebook} className='w-7 h-7'/>
                          <span>H'kaiye Oluwatimilehin Pacem</span>
                        </a>
                      </div>
                    </div>
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">This is really huge!! They say "A nation without productive youths is a nation without hope, and a nation without hope is a nation without future...
                      You can't go wrong by investing in the youths, youths are game changers, and creative thinkers.</h4>
                      <div>
                        <a className="btn-sm text-white bg-blue-500 hover:bg-blue-600 group shadow-sm" href="#0">
                          Read Story <span className="tracking-normal text-blue-200 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                        </a>
